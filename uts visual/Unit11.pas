...
begin
   if (Edit1.Text = '') or (Edit1.Text = '00:00') or (Edit2.Text = '') or (Edit2.Text = '00:00') then
    ...
    (Form10.ADOQuery1.Locate('hari',ComboBox1.Text,[])) or (Form10.ADOQuery1.Locate('jam_mulai',Edit1.Text,[])) then
      begin
      ...
      begin
        a := Form10.ADOQuery1.RecordCount + 1;
        with Form10.ADOQuery1 do // Simpan kode
        begin
          SQL.Clear;
...
begin
  try
    updt :=Form10.ADOQuery1.Fields[0].AsString;
    Edit1.Text:= Form10.ADOQuery1.Fields[1].AsString;
    Edit2.Text:= Form10.ADOQuery1.Fields[2].AsString;
    ComboBox1.Text:= Form10.ADOQuery1.Fields[3].AsString;
    DateTimePicker1.Date:=Form10.ADOQuery1.Fields[4].AsDateTime;
    Edit3.Text:= Form10.ADOQuery1.Fields[5].AsString;
    Edit4.Text:= Form10.ADOQuery1.Fields[6].AsString;
    Edit5.Text:= Form10.ADOQuery1.Fields[7].AsString;
    Edit6.Text:= Form10.ADOQuery1.Fields[8].AsString;
...
begin
  if (Edit1.Text = '') or (Edit1.Text = '00:00') or (Edit2.Text = '') or (Edit2.Text = '00:00') then
    ...
    else if (Edit1.Text= form10.ADOQuery1.Fields[1].AsString) and (ComboBox1.Text=form10.ADOQuery1.Fields[2].AsString) then
      begin
